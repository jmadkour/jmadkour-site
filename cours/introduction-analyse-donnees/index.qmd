...
Le cours d'analyse des données du **niveau Master** reprend l'ensemble depuis le début et l'approfondit : correspondances multiples, classification, analyse discriminante, positionnement multidimensionnel, mise en œuvre sur R et Python.
